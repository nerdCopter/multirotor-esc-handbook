...
* **Desync Prevention Setup:**
  ...
  * **PWM Frequency — two real data points in tension for BLHeli_32, present both rather than picking one:**
      ...
      * **AM32 has the same three modes available** (Fixed 24kHz, Fixed 48kHz, Variable/By-RPM) — it isn't limited to Variable. The same 24-vs-48kHz tradeoff above applies if you run AM32 in Fixed mode. Chris Rosser's AM32-specific test ([3SHzyUaypFw](https://youtu.be/3SHzyUaypFw): "definitely use the variable pwm") leans toward **Variable/By-RPM** as his tested recommendation for AM32 specifically — consistent with the AM32 creator's own framing of that feature's intended design ([am32.md](am32.md#dynamic-pwm-modes--pwm-by-rpm)). BLHeli_32 and AM32 have separate sourced defaults for this reason — the AM32 finding above does not carry over to BLHeli_32, and vice versa.
