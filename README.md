...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Whoop** | 31–40mm / 0702–1002 | 1S–2S | [Bluejay](bluejay.md) / [AM32](am32.md) | **48kHz (default)** — Bluejay's own maintainers called 96kHz "pretty much useless" and removed it once over reduced PWM resolution, restoring it only after user pushback ([see bluejay.md](bluejay.md#pwm-switching-frequency-breakdown)). 96kHz can test out positive on low-dead-time ESCs, but check your ESC's dead time and don't assume it's free efficiency | 15°–22.5° | Step up from LOW through HIGH only as needed. LOW is typical. Desyncs primarily mitigated by proper timing | Use official [Bluejay Motor Idle table](bluejay.md#startup-power-motor-idle--rpm-power-protection-official-wiki-data) (8%–16%) |
| **Micro / 3.5"** | 2.5"–3.5" / 1404–1507 | 4S–6S | [AM32](am32.md) / [BLHeli_32](blheli32.md) | **AM32:** Variable 36-72kHz (3" tested-best). **BLHeli_32:** fixed 24kHz (3" tested-best) — avoid >48kHz fixed, documented to fail to spin up cleanly on a 3" motor. Different firmwares, different sourced numbers — see [desyncs.md](desyncs.md), §2 | **AM32:** 15°. **BLHeli_32:** 24° (both sourced, different tests) | Step up from LOW through HIGH only as needed. LOW is typical. Desyncs primarily mitigated by proper timing | 5.5%–7% (unverified community range, or 3500 RPM) |
| **5" Freestyle** | 5"–5.1" / 2207–2306 | 6S | [AM32](am32.md) / [BLHeli_32](blheli32.md) | 24kHz (BLHeli_32 tested-best, 2024) or 48kHz (common non-race default) — both on either firmware; Variable/By-RPM 24-48kHz also a reasonable alternative ([desyncs.md §3](desyncs.md#3-master-settings-matrix-across-all-esc-firmwares)) | 22°–23° (sourced, 2021; see desyncs.md §3 for newer, more granular 2024 BLHeli_32 data) | Step up from LOW through HIGH only as needed. LOW is typical. Desyncs primarily mitigated by proper timing | 5.5%–6.5% (unverified community range, or 3200 RPM) |
| **5" Racing** | 5" / 2207–2208 High Kv | 6S | [BLHeli_32](blheli32.md) / [AM32](am32.md) | **24kHz** | 22°–23°+ | OFF if not desyncing, otherwise LOW — see [desyncs.md, §4 "5-Inch Racing Optimization"](desyncs.md) | 5.5%–6.5% (unverified community range, or 3500 RPM) |
| **7"–10" Macro** | 7"–10" / 2806.5–3115 | 6S–12S | [AM32](am32.md) / [BLHeli_32](blheli32.md) | **24kHz** static (reasoning-based, not a citation) — on AM32, 24-48kHz Variable/By-RPM is sourced for **7" specifically**; 8"-10" PWM isn't tested by any source | 15°–18° | Step up from LOW through HIGH only as needed. LOW is typical. Desyncs primarily mitigated by proper timing | 6%–8% (unverified community range, or 2500 RPM) |
